...
export default function ErrorState({ errorType, message, onRetry }: ErrorStateProps) {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 p-6 bg-gradient-to-br from-red-50 to-rose-100/50 dark:from-slate-800 dark:to-slate-800/80 border border-red-300 dark:border-red-700/80 rounded-2xl shadow-md text-red-900 dark:text-red-200">
